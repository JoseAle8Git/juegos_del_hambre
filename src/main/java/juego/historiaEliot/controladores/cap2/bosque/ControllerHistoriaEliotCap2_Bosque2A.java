...
public class ControllerHistoriaEliotCap2_Bosque2A {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque2RespuestaA.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(37);
