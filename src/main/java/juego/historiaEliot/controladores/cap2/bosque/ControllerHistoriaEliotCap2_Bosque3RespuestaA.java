...
public class ControllerHistoriaEliotCap2_Bosque3RespuestaA {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque3FinalA.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(33);
