...
public class ControllerHistoriaEliotCap2_Bosque implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Acabas de llegar al bosque para encontrar a tu padre. Ambos sabeis que la Cosecha se acerca y compartís un silencio cargado de preocupación y tristeza."
    );
    ...
    private void irASiguienteVista() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque1.fxml"));
