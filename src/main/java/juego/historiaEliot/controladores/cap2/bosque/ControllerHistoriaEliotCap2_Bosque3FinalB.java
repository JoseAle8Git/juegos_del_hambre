...
public class ControllerHistoriaEliotCap2_Bosque3FinalB implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Asientes con la mirada lentamente, sin decir nada, pero con una firmeza renovada\n en tu postura y procedes a retirarte."
    );
