...
public class ControllerHistoriaEliotCap2_Bosque3B {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque3RespuestaB.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(40);
