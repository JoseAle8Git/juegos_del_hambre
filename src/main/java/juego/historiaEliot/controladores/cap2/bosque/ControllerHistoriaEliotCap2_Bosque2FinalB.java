...
public class ControllerHistoriaEliotCap2_Bosque2FinalB implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Miras a tu padre a los ojos y le das un abrazo que os tranquiliza\n a ambos y procedes a retirarte."
    );
