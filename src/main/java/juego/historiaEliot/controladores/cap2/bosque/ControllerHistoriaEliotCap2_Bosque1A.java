...
public class ControllerHistoriaEliotCap2_Bosque1A {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque1RespuestaA.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(35);
