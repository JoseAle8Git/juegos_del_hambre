...
public class ControllerHistoriaEliotCap2_Bosque2B {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/bosque/historiaEliotCap2-Bosque2RespuestaB.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(38);
