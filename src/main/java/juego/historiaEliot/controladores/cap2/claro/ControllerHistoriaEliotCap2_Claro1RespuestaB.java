...
public class ControllerHistoriaEliotCap2_Claro1RespuestaB {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/claro/historiaEliotCap2-Claro7A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/claro/historiaEliotCap2-Claro7B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(60);
        String btnTextoA = dialogoDAO.obtenerTextobtn(81);
        String btnTextoB = dialogoDAO.obtenerTextobtn(82);
