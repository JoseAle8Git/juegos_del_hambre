...
public class ControllerHistoriaEliotCap2_1 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Te levantas temprano el día de antes del día de la cosecha y tienes muchas cosas que hacer."
    );
