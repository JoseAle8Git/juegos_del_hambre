...
public class ControllerHistoriaEliotCap2_DispensarioFinalVendas {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/dispensario/historiaEliotCap2-DispensarioIntroHoguera.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(49);
