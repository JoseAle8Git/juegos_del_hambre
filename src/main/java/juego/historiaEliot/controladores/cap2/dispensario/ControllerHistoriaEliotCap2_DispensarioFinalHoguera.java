...
public class ControllerHistoriaEliotCap2_DispensarioFinalHoguera {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        ...
        if(control.getClaro() && control.getDispensario() && control.getBosque()) {
            try {
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(51);
