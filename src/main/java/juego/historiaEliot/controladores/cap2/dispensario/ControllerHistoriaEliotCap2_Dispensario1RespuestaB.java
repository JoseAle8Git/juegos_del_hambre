...
public class ControllerHistoriaEliotCap2_Dispensario1RespuestaB {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap2/dispensario/historiaEliotCap2-Dispensario3A.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(44);
        String btnTextoA = dialogoDAO.obtenerTextobtn(56);
