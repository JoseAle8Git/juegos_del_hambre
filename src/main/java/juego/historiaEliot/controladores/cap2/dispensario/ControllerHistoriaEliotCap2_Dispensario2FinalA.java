...
public class ControllerHistoriaEliotCap2_Dispensario2FinalA implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Luna se cruza de brazos, visiblemente molesta, desvía la mirada y se vá."
    );
