...
public class ControllerHistoriaEliotCap1_1 implements Initializable {

    @FXML private Label fraseLabel;
    private final List<String> frases = List.of(
            "El polvo de carbón flota en el aire y cubre la ropa de los mineros mientras se dispersan en varias direcciones.",
            "Al salir, Eliot observa la familiar intersección del distrito y reflexiona sobre lo que quiere hacer antes de que oscurezca."
    );
    ...
    private void irAHistoriaEliotCap1_2() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/historiaEliotCap1-2.fxml"));
