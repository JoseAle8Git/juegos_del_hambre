...
public class ControllerHistoriaEliotCap1_Casa3B {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa3RespuestaB.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(17);
