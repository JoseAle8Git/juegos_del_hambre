...
public class ControllerHistoriaEliotCap1_Casa2 {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa2A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa2B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(20);
        String btnTextoA = dialogoDAO.obtenerTextobtn(14);
        String btnTextoB = dialogoDAO.obtenerTextobtn(15);
