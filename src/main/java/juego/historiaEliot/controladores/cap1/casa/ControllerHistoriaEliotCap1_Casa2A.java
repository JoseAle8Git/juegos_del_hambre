...
public class ControllerHistoriaEliotCap1_Casa2A {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa2RespuestaA.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(14);
