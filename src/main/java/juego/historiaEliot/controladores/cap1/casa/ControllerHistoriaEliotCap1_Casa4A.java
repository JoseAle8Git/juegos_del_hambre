...
public class ControllerHistoriaEliotCap1_Casa4A {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa4RespuestaA.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(18);
