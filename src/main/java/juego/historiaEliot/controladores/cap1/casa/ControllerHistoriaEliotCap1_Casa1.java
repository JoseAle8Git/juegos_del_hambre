...
public class ControllerHistoriaEliotCap1_Casa1 implements Initializable {

    @FXML
    Label fraseLabel;
    private final List<String> frases = List.of(
            "Llegas a casa después de un largo día de trabajo en la mina. Al entrar, ve a su hermano menor, Sam, tallando un pequeño sinsajo de madera en el suelo. Sam levanta la vista y sonríe débilmente al verlo entrar."
    );
    ...
    private void irAHistoriaEliotCap1Mercado2() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa2.fxml"));
