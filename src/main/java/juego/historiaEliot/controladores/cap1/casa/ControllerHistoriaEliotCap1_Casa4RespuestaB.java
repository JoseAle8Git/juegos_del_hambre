...
public class ControllerHistoriaEliotCap1_Casa4RespuestaB {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/puzles/puzlePrueba2.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(26);
