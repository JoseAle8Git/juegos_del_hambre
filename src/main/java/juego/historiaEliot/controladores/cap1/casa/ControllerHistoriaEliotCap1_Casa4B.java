...
public class ControllerHistoriaEliotCap1_Casa4B {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/casa/historiaEliotCap1-Casa4RespuestaB.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(19);
