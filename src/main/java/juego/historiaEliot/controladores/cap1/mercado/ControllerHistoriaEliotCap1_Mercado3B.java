...
public class ControllerHistoriaEliotCap1_Mercado3B {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/mercado/historiaEliotCap1-Mercado3RespuestaB.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(4);
