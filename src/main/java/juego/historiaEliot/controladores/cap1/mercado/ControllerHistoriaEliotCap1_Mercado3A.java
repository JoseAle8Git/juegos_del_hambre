...
public class ControllerHistoriaEliotCap1_Mercado3A {
    ...
    @FXML private void irASegundaInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/mercado/historiaEliotCap1-Mercado3RespuestaA.fxml"));
        ...
        String texto = dialogoDAO.obtenerTexto(3);
