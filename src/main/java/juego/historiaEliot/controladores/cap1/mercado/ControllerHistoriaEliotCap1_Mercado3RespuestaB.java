...
public class ControllerHistoriaEliotCap1_Mercado3RespuestaB {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/puzles/puzlePrueba1.fxml"));
            ...
            ex.printStackTrace();
            mostrarAlerta("Error", "No se pudo mostrar la siguiente vista del puzle1");
        }
    }private void iniciarEscena() {
        DialogoDAO dialogoDAO = new DialogoDAO();
        String texto = dialogoDAO.obtenerTexto(10);
