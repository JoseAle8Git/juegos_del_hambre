...
public class ControllerHistoriaEliotCap1_Mercado4RespuestaA {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap1/mercado/historiaEliotCap1-Mercado4Final.fxml"));
            ...
            ex.printStackTrace();
            mostrarAlerta("Error", "No se pudo mostrar la siguiente vista del mercado4final");
        }
    }private void iniciarEscena() {
        DialogoDAO dialogoDAO = new DialogoDAO();
        String texto = dialogoDAO.obtenerTexto(12);
