...
public class ControllerCombateCato {
    ...
    private void irASiguienteVista() {
        ...
        mostrarAlerta("Ganador", "Has ganado los juegos del hambre");
        if(controlJuegosDelHambre.isLunaAliada()) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/cap6/tributoEliot/juegosDelHambre/final1JuegosDelHambre.fxml"));
                Parent root = loader.load();
                Stage stage = (Stage) mensajeCombate.getScene().getWindow();
                stage.setScene(new Scene(root));
                stage.show();
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/cap6/tributoEliot/juegosDelHambre/final2JuegosDelHambre.fxml"));
                Parent root = loader.load();
                Stage stage = (Stage) mensajeCombate.getScene().getWindow();
                stage.setScene(new Scene(root));
                stage.show();
