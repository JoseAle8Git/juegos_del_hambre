...
public class ControllerFinal1JuegosDelHambre implements Initializable {
    ...
    private final List<String> frases = List.of(
            ...
            "Al caer tan bien y haber tomado decisiones de revancha contra el Capitolio provocaste un cambio en la cabeza de la gente de Panem.",
            "Empiezas una revolución un año después hasta que consigues derrocar al Capitolio imponiendo una democracia en Panem.",
            "Fin"
    );
    ...
    private void irASiguienteVista() {
        ranking.setFinalJuego("Ganas los juegos del hambre pero causas un sentimiento de revolución en Panem entero que buscará un cambio en el futuro.");
