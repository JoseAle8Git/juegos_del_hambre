...
public class ControllerHistoriaEliotCap6Tributo1_6 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Al llegar al área, ves a los tributos en sus respectivas habitaciones, vigilados de cerca por cámaras y guardias. Tu mirada busca ansiosamente a Sam, pero no logra ver nada."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/cap6/tributoSam/historiaEliotCap6Tributo1-7.fxml"));
