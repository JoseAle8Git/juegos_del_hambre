...
public class ControllerHistoriaEliotCap6Tributo1_5 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "El general asiente, sin detenerse más de lo necesario. Sientes alivio momentáneo mientras otros guardias son asignados a tareas diferentes.",
            "Con tu tarea asignada, eres llevado junto a un grupo reducido de guardias al área donde están confinados los tributos.",
            "Mientras caminas, aprovechas para analizar tu entorno: pasillos largos, puertas custodiadas, cámaras en cada esquina y varios guardias. Es evidente que escapar con Sam no será fácil."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/cap6/tributoSam/historiaEliotCap6Tributo1-6.fxml"));
