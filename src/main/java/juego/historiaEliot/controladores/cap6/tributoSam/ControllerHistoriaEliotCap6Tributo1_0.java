...
public class ControllerHistoriaEliotCap6Tributo1_0 implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Capítulo 6: Sombras en el Capitolio"
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/cap6/tributoSam/historiaEliotCap6Tributo1-1.fxml"));
