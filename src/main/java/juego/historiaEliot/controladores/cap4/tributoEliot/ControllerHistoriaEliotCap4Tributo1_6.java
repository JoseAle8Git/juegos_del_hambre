...
public class ControllerHistoriaEliotCap4Tributo1_6 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Abres la puerta al siguiente vagón y te encuentras con una figura descuidada y desaliñada que se reclina en un sofá de cuero con una botella de licor en la mano: Heymitch Abernathy, el mentor de los tributos del Distrito 12.",
            "Al verlo entrar, Heymitch arquea una ceja y, con una sonrisa irónica, rompe el silencio."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-7.fxml"));
