...
public class ControllerHistoriaEliotCap4Tributo1_8 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Mientras Heymitch da otro trago a su botella, la puerta del vagón se abre con un sonido suave y mecánico.",
            "Effie Trinket entra, con su extravagante atuendo de colores brillantes y su característico cabello perfectamente estilizado. Su sonrisa forzada es más aguda que nunca mientras sus ojos escanean a Eliot con un aire de evaluación."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-9.fxml"));
