...
public class SeguroArquero {

    @FXML
    public  void irASiguienteVista(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo2-7arqueroSi.fxml"));
