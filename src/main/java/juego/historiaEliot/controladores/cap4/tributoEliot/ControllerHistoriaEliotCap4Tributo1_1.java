...
public class ControllerHistoriaEliotCap4Tributo1_1 implements Initializable {
    ...
    private final List<String> frases = List.of(
            "La estación está llena de una quietud tensa, rota únicamente por el silbido del tren y el sonido de las puertas deslizándose para abrirse.",
            "Estás junto a tu padre y Sam, ambos con expresiones graves mientras intentan encontrar las palabras adecuadas para este momento."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-2.fxml"));
