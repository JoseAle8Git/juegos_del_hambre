...
public class ControllerHistoriaEliotCap4Tributo1_4 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Te subes al tren, dejando atrás a tu familia mientras las puertas se cierran con un sonido metálico.",
            "El tren comienza a moverse, llevándote hacia un destino incierto."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-5.fxml"));
