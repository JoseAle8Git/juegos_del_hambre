...
public class ControllerHistoriaEliotCap4Tributo1_5 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Entras en un vagón solitario, con un diseño lujoso pero frío. Los asientos están tapizados en terciopelo, y una mesa al centro sostiene una jarra de agua cristalina junto con algunos vasos.",
            "Te quedas un momento en silencio, mirando por la ventana el paisaje que se desvanece. Finalmente, decides avanzar al siguiente vagón, donde se escuchan voces apagadas."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-6.fxml"));
