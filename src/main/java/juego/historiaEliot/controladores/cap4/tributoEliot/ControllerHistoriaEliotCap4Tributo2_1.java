...
public class ControllerHistoriaEliotCap4Tributo2_1 {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo2-1A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo2-1B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(105);
        String btnTextoA = dialogoDAO.obtenerTextobtn(118);
        String btnTextoB = dialogoDAO.obtenerTextobtn(119);
