...
public class ControllerHistoriaEliotCap4Tributo1_2 {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoSam/historiaEliotCap4Tributo1-2A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoSam/historiaEliotCap4Tributo1-2B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(133);
        String btnTextoA = dialogoDAO.obtenerTextobtn(137);
        String btnTextoB = dialogoDAO.obtenerTextobtn(138);
