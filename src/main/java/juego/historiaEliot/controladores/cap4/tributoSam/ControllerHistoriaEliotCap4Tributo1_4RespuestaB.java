...
public class ControllerHistoriaEliotCap4Tributo1_4RespuestaB {
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoSam/historiaEliotCap4Tributo1-6A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoSam/historiaEliotCap4Tributo1-6B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(136);
        String btnTextoA = dialogoDAO.obtenerTextobtn(145);
        String btnTextoB = dialogoDAO.obtenerTextobtn(146);
