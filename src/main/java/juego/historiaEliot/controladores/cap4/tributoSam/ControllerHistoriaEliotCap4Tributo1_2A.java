...
public class ControllerHistoriaEliotCap4Tributo1_2A {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoSam/historiaEliotCap4Tributo1-2RespuestaA.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(137);
