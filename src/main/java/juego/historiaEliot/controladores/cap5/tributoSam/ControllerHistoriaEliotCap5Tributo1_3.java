...
public class ControllerHistoriaEliotCap5Tributo1_3 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Rye y tú os escondeis detrás de un vagón de carga cerca de las vías del tren. Un guardia de la paz solitario patrulla el área. Eliot toma un respiro profundo, sabiendo que este enfrentamiento determinará si pueden continuar con el plan."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoSam/historiaEliotCap5Tributo1-4.fxml"));
