...
public class ControllerHistoriaEliotCap5Tributo1_4 {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoSam/historiaEliotCap5Tributo1-5.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(149);
