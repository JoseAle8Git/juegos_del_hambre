...
public class ControllerHistoriaEliotCap5Tributo1_2Respuesta implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Rye explica que tendrán que enfrentarse a un guardia de la paz para tomar su uniforme, lo que permitirá a Eliot camuflarse y abordar el tren. El riesgo es alto, pero Rye insiste en ayudar."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoSam/historiaEliotCap5Tributo1-3.fxml"));
