...
public class ControllerHistoriaEliotCap5Tributo1_7 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Vestido con el uniforme, Ray y tú os acercais al tren. Los latidos de tu corazón son ensordecedores mientras intentas pasar desapercibido. Sin embargo, un grupo de guardias aparece justo cuando estais a punto de abordar."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoSam/historiaEliotCap5Tributo1-8.fxml"));
