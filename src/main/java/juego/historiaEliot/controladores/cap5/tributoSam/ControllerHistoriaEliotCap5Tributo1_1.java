...
public class ControllerHistoriaEliotCap5Tributo1_1 implements Initializable {
    ...
    private final List<String> frases = List.of(
            "Te encuentras sentado junto a Ray, ambos visiblemente tensos por lo que está por venir. La tenue luz de una lámpara de aceite ilumina sus rostros.",
            "Tienes una mirada decidida, pero hay un toque de duda en tus ojos. Rye, como siempre, trata de mantener el ánimo, aunque sabe que el plan es arriesgado."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoSam/historiaEliotCap5Tributo1-2.fxml"));
