...
public class ControllerHistoriaEliotCap5Tributo2_3 {
    ...
    public void initialize() {
        ...
        opcionA.setText(dialogoDAO.obtenerTextobtn(205));
        opcionB.setText(dialogoDAO.obtenerTextobtn(206));
    }
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-3A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-3B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
