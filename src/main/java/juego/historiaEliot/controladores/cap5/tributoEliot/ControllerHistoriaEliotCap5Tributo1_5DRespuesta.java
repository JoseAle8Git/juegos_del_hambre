...
public class ControllerHistoriaEliotCap5Tributo1_5DRespuesta {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo1-6.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(183);
    ...
    @FXML public void initialize() {
        ...
        controlCap5.setTrajeFuego(true);
        iniciarEscena();
    }
