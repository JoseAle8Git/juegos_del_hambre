...
public class ControllerHistoriaEliotCap5Tributo2_0 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Ambos tributos intercambian una mirada, sus emociones reflejando la importancia del momento.",
            "Es hora de enfrentarse al público del Capitolio y dejar una impresión que podría definir su destino."
    );
    ...
    private void irASiguienteVista() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-1.fxml"));
