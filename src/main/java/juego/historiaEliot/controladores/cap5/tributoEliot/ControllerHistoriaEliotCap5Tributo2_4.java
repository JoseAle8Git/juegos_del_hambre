...
public class ControllerHistoriaEliotCap5Tributo2_4 {
    ...
    public void initialize() {
        ...
        opcionA.setText(dialogoDAO.obtenerTextobtn(207));
        opcionB.setText(dialogoDAO.obtenerTextobtn(208));
    }
    ...
    @FXML private void irAOpcionA(ActionEvent e) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-4A.fxml"));
    ...
    @FXML private void irAOpcionB(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-4B.fxml"));
            Scene scene = new Scene(loader.load());
            Stage stage = (Stage) ((Node) e.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
