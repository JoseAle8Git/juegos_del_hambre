...
public class ControllerHistoriaEliotCap5Tributo2_5 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "El desfile llega a su clímax cuando todos los carruajes se detienen frente al edificio principal del Capitolio.",
            "En lo alto de una plataforma decorada con los símbolos de Panem, el presidente Coriolanus Snow se levanta de su asiento.",
            "Su presencia impone respeto y temor en igual medida. Con su traje blanco impecable y su sonrisa calculada, Snow toma el micrófono mientras el silencio cae sobre la multitud."
    );
    ...
    private void irASiguienteVista() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo2-6.fxml"));
