...
public class ControllerHistoriaEliotCap5Tributo1_8ARespuesta {
    ...
    @FXML private void irASiguienteInteraccion(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo1-9A.fxml"));
    ...
    private void iniciarEscena() {
        ...
        String texto = dialogoDAO.obtenerTexto(193);
