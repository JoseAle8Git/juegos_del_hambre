...
public class ControllerHistoriaEliotCap5Tributo1_6 implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Al día siguiente",
            "Te encentras parado junto a Luna al lado del carruaje en la zona de preparación.",
            "Los caballos están listos, y el resplandor de las luces del Capitolio brilla desde la entrada de la avenida donde se llevará a cabo el desfile.",
            "Te mira Luna, con una mezcla de nerviosismo y tristeza en su rostro."
    );
    ...
    private void irASiguienteVista() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap5/tributoEliot/historiaEliotCap5Tributo1-7.fxml"));
