...
public class ControllerHistoriaEliotCap3_7RespuestaAFinal implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Sam rompe a llorar, corriendo hacia su padre mientras tu te subes al escenario junto a Luna.",
            "Esta dicisión te llevara en un par de días a una arena combate y cruel, es hora de prepararse para la carnicería que se viene."
    );
    ...
    private void irAHistoriaEliotCap1_1() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/historiaEliot/Cap4/tributoEliot/historiaEliotCap4Tributo1-0.fxml"));
