...
public class ControllerHistoriaEliotCap3_7RespuestaBFinal implements Initializable {

    @FXML
    private Label fraseLabel;
    private final List<String> frases = List.of(
            "Luna y Sam están juntos en el escenario.",
            "Eliot siente el peso de su desición mientras el resto de la ceremonia pasa en un borrón."
    );
