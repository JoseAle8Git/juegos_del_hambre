...
public class Normal extends ClaseCombate {
    ...
    public Normal() {
        ...
        ataques.add(new Ataque("Golpe básico", 15, 0.95, EfectoEspecial.NINGUNO));
        ataques.add(new Ataque("Patada segadora", 10, 0.90, EfectoEspecial.FALLAR_SIGUIENTE_ATAQUE));
        ataques.add(new Ataque("Empujón revisado", 5, 0.85, EfectoEspecial.REDUCIR_DANO_SIGUIENTE_ATAQUE));
