...
public class Cazador extends ClaseCombate {
    ...
    public Cazador() {
        ...
        ataques.add(new Ataque("Flecha penetrante", 35, 0.90, EfectoEspecial.IGNORAR_ESCUDO));
        ataques.add(new Ataque("Trampa de caza", 40, 0.95, EfectoEspecial.INMUNE_EFECTOS_SIGUIENTE_TURNO));
        ataques.add(new Ataque("Tiro de reacción", 35, 0.85, EfectoEspecial.BONUS_DANO_SI_FUE_ATACADO_ANTES));
