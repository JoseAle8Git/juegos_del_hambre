...
public class Soldado extends ClaseCombate {
    ...
    public Soldado() {
        ...
        ataques.add(new Ataque("Disparo preciso", 25, 0.75, EfectoEspecial.CRITICO_ADICIONAL));
        ataques.add(new Ataque("Granada aturdidora", 15, 0.50, EfectoEspecial.PERDER_TURNO));
        ataques.add(new Ataque("Bayoneta", 20, 0.70, EfectoEspecial.IGNORAR_ESCUDO));
