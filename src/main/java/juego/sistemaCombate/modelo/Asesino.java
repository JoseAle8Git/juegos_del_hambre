...
public class Asesino extends ClaseCombate {
    ...
    public Asesino() {
        ...
        ataques.add(new Ataque("Puñalada letal", 35, 0.70, EfectoEspecial.EJECUTAR_SI_VIDA_BAJA));
        ataques.add(new Ataque("Corte doble", 15, 0.90, EfectoEspecial.SIN_DEFENSA_SIGUIENTE_TURNO));
        ataques.add(new Ataque("Veneno silencioso", 10, 0.80, EfectoEspecial.VENENO_3T));
