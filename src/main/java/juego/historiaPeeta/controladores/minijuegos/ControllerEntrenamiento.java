...
//            ButtonType siguiente = new ButtonType("Continuar");
//            alert.getButtonTypes().setAll(siguiente, ButtonType.CLOSE);

//            Optional<ButtonType> result = alert.showAndWait();
//            if (result.isPresent() && result.get() == siguiente) {
//                cambiarVista("view/resultado.fxml");
//            } else {
//                Platform.exit();
//            }
            alert.showAndWait();
